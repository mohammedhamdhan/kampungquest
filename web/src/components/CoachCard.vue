<template>
  <div
    v-if="isYouthMode"
    class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4 rounded-r-lg dark:bg-blue-900/20 dark:border-blue-500"
    role="complementary"
...
const { isYouthMode } = useMode()

// Track analytics when coach card is shown
// TODO: Add analytics tracking
console.log('Coach card shown')
</script>